  ...
  <section class="gallery-links">
            <div class="wrapper">
                ...
                <div class=folder-container
                    ...
                    while ($album_data = $albums->fetch_assoc()) {
                        ...
                        <b></b> <a href='view-album.php?album_id=<?php echo $album_data['album_id'] ?>'>
        ...
        <?php if(isset($_SESSION['Admin']) && $_SESSION['Admin'] == 1){ ?>
            <div class="folder-upload">
                <div class="folder-upload-form">
                    <form method="POST" action="includes/add-album.php">
                        <label>Add New Album:</label><br><br>
                        <input class="album-add"  type="text" name="album_name" placeholder="Album name..."/> <br> <br>
                        <label for="Date">Choose a Date:</label>
                        <select class="dropdown" name="Date" id="Date">
